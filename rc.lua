...
--    awful.key({ modkey,           }, "space", function () awful.layout.inc( 1)                end,
    awful.key({ modkey,           }, "space", function () awful.layout.set(awful.layout.layouts[1])                end,
              {description = "select next", group = "layout"}),
--    awful.key({ modkey, "Shift"   }, "space", function () awful.layout.inc(-1)                end,
    awful.key({ modkey, "Shift"   }, "space", function () awful.layout.set(awful.layout.layouts[9])                end,
...
function notify(text_in)
    naughty.notify({text=text_in})
end
